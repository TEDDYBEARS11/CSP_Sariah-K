...
print("Your rent is", rent/income*100, "percent of your income")
#calculate percent income of utilities(utilities/income*100) (variable)
print("your utilities is", utilities/income*100, "percent of your utilities")
#calculate percent income of groceries(groceries/income*100) (variable)
print("your groceries is", groceries/income*100, "percent of your groceries")
#calculate percent income of transportation(transportation/income*100) (variable)
print("yout transportation is", transportation/income*100, "percent of your transportation")
#calculate percent income of spending(spending/income*100) (variable)
print("your spending is", (income-rent-utilities-groceries-transportation-income*.1)/income*100, "percent of your spending")
